...
@Component({
  ...
  template: `
      ...
      <p>CIT Open Data Hackathon May 18th: Rent Checkers Team – By reviewing a broad range of Central Statistics Office data on the rental
        sector in Ireland, the pitched</p> idea would enable a fairer environment for tenants, showing real-time stats to be visualised in main rent platforms and avoiding exploitings from the landlords side.
